              ...
              <div class="page-title-container">
                <div class="row">
                  ...
                  <div class="col-12 col-md-7">
                    <h1 class="mb-0 pb-0 display-4" id="title">Stations</h1>
                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                      <ul class="breadcrumb pt-0">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Network</a></li>
                        <li class="breadcrumb-item"><a href="Devices.php">Stations</a></li>
                      </ul>
                    </nav>
                  </div>
                  <!-- Title End -->
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                    <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground" >
                              ...
                              <select class="form-control" name="selectDevices" id="selectDevices" >
...
if (typeof AcornIcons !== 'undefined') {
  new AcornIcons().replace();
      ...
      $( document ).ready(function() {
          ...
          LDevicesSelect('<?php echo $iddevice;?>','AccessPoint');

          LStations('<?php echo $param;?>','<?php echo $iddevice;?>');
      ...
      $('#selectDevices').change(function() {
        ...
        var iddevice=document.getElementById('selectDevices').value;

       location.href="Stations.php?param="+param+"&iddevice="+iddevice;
